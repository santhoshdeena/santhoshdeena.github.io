!function(a, b, c, d) {
    ...
    a.extend(e.prototype, {
        ...
        compute: function() {
            ...
            i = h / m) : b.settings.maxHeight > 0 && (i = b.settings.maxHeight,
            h = i * m);
            var o, p, q, r, s;
            n > m ? (o = i < j.viewport.h ? i : j.viewport.h * b.settings.viewportFill,
            q = o / l,
            r = h * (l * q / i) / k,
            s = q) : (p = h < j.viewport.w ? h : j.viewport.w * b.settings.viewportFill,
            r = p / k,
            q = i * (k * r / h) / l,
            s = r),
